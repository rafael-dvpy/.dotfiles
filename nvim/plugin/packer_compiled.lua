...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  harpoon = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
  ...
  ["startup.nvim"] = {
    ...
    loaded = true,
    path = "/home/rafael/.local/share/nvim/site/pack/packer/start/startup.nvim",
